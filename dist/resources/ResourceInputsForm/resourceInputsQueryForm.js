...
const ResourceCrudQueryForm = _ref => {
  ...
  return loading ? _react.default.createElement(_LoaderSpinner.default, null) : _react.default.createElement(_resourceInputsFormWrapper.default, {
    onSubmit: handleSubmit
  }, children || arrayOfValues.map(_ref2 => {
    let {
      field,
      value,
      isArray,
    ...
    return _react.default.createElement(_UniversalInput.default, {
  ...
  }), _react.default.createElement(_buttonsWrapper.default, null, _react.default.createElement(_button.Button, {
    loading: loading,
